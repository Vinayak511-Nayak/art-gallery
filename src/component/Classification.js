...
const Classification = (props) => {
  ...
  useEffect(() => {
    async function classificationData() {
      try {
        const response = await axios.get(
          `https://api.harvardartmuseums.org/object?classification=${classificationName}&apikey=8d1c8a53-95e9-43d2-aee5-2bf8403468ce`
        );
    ...
    classificationData();
  }, [classificationName]); // Run effect whenever culturename changes
