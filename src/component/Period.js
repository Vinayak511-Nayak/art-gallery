...
const Period = (props) => {
  ...
  useEffect(() => {
    async function periodData() {
      try {
        const response = await axios.get(
          `https://api.harvardartmuseums.org/object?period=${periodName}&apikey=8d1c8a53-95e9-43d2-aee5-2bf8403468ce`
        );
    ...
    periodData();
  }, [periodName]); // Run effect whenever culturename changes
